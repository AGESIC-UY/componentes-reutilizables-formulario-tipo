...
<!-- 
                    ...
                    <div class="Tabs">
                        ...
                        <ul class="Tabs-nav" role="tablist">
                            ...
                            <a href="#tablink-1" class="Tabs-link" aria-controls="tab-1" role="tab" data-toggle="tab" id="tab-1">Pestaña 1</a>
                            </li>
                            <li role="presentation" class="Tabs-item">
                            <a href="#tablink-2" class="Tabs-link" aria-controls="tab-2" role="tab" data-toggle="tab" id="tab-2">Pestaña 2</a>
                            </li>
                            <li role="presentation" class="Tabs-item">
                            <a href="#tablink-3" class="Tabs-link" aria-controls="tab-3" role="tab" data-toggle="tab" id="tab-3">Pestaña 3</a>
                            </li>
                            <li role="presentation" class="Tabs-item">
                            <a href="#tablink-4" class="Tabs-link" aria-controls="tab-4" role="tab" data-toggle="tab" id="tab-4">Pestaña 4</a>
                            </li>
                        </ul>
                    ...
                    <div class="Tabs-content">
                        ...
                        <div role="tabpanel" class="Tabs-pane fade in active" id="tablink-1" aria-labelledby="tab-1">Contenido de la Pestaña 1</div>
                        ...
                        <div role="tabpanel" class="Tabs-pane fade" id="tablink-4" aria-labelledby="tab-4">Contenido de la Pestaña 4</div>
